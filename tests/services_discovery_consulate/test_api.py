...
class ConsulTests(unittest.TestCase):
    @mock.patch('pyms.services_discovery.consulate.adapters.Request')
    @mock.patch('pyms.services_discovery.consulate.api.Agent')
    @mock.patch('pyms.services_discovery.consulate.api.Catalog')
    @mock.patch('pyms.services_discovery.consulate.api.KV')
    @mock.patch('pyms.services_discovery.consulate.api.Health')
    @mock.patch('pyms.services_discovery.consulate.api.Coordinate')
    @mock.patch('pyms.services_discovery.consulate.api.ACL')
    @mock.patch('pyms.services_discovery.consulate.api.Event')
    @mock.patch('pyms.services_discovery.consulate.api.Session')
    @mock.patch('pyms.services_discovery.consulate.api.Status')
